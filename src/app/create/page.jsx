    ...
    <div className='container mx-auto py-10'>
      ...
      <Link href="/" className='bg-gray-500 inline-block text-white border py-2 px-3 rounded my-2'>Go back</Link>
        <form onSubmit={handleSubmit}>
            ...
            <textarea onChange={(e) => setContent(e.target.value)} name="" id="" cols="30" rows="10" className='w-{300px} block bg-gray-200 border py-2 px-3 rounded text-lg my-2' placeholder="Enter your contents"></textarea>
